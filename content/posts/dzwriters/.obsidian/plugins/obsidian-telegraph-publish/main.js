...
var require_cash = __commonJS({
  "node_modules/cash-dom/dist/cash.js"(exports2, module2) {
    (function() {
      "use strict";
      var propMap = {
        "class": "className",
      ...
      function camelCase(str2) {
        return str2.replace(dashAlphaRe, function(match, letter) {
      ...
      function getCompareFunction(comparator) {
        return isString2(comparator) ? function(i, ele) {
      ...
      function getSplitValues(str2) {
        return isString2(str2) ? str2.match(splitValuesRe) || [] : [];
      }
      ...
      fn.off = function(eventFullName, selector, callback) {
        ...
        } else if (!isString2(eventFullName)) {
      ...
      fn.has = function(selector) {
        var comparator = isString2(selector) ? function(i, ele) {
      ...
      fn.not = function(comparator) {
        ...
        return this.filter(function(i, ele) {
          return (!isString2(comparator) || isElement(ele)) && !compare.call(ele, i, ele);
        });
      };
...
var import_cash_dom = __toModule(require_cash());
...
${content}`;
  ...
  const maybeKeyIndex = oldMatterSplitted.findIndex((it) => it[0] === key && it.length === 2);
  if (maybeKeyIndex >= 0) {
...
var HTMLSource;
(function(HTMLSource2) {
  HTMLSource2["Preview"] = "Preview";
  HTMLSource2["MarkdownRenderer"] = "MarkdownRenderer";
...
var TelegraphPublishPlugin = class extends import_obsidian2.Plugin {
  ...
  getActiveFilePage() {
    return __async(this, null, function* () {
      ...
      let content = yield this.app.vault.read(view.file);
  ...
  publishActiveFileSafe() {
    return __async(this, null, function* () {
      const cleanups = [];
      try {
        yield this.publishActiveFile(cleanups);
      } finally {
  ...
  publishActiveFile(cleanups) {
    return __async(this, null, function* () {
      const view = this.app.workspace.getActiveViewOfType(import_obsidian2.MarkdownView);
      const file = view.file;
      yield view.leaf.setViewState(__spreadProps(__spreadValues({}, view.leaf.getViewState()), {
        state: __spreadProps(__spreadValues({}, view.getState()), {
          mode: "preview"
        })
      }));
      ...
      if (this.settings.htmlSource === HTMLSource.Preview) {
        ...
        contentEl = (0, import_cash_dom.default)(containerEl).find(".markdown-preview-section")[0];
        if (contentEl === void 0) {
  ...
  clearPublished() {
    return __async(this, null, function* () {
      ...
      const file = view.file;
      const [, pagePath] = yield this.getActiveFileContent(view);
      const page = yield this.getClient().editPage({
        path: pagePath,
        title: file.basename,
        content: ["Deleted"]
      }).catch((e) => {
...
var PublishModal = class extends import_obsidian2.Modal {
  ...
  confirm(action, fileTitle, func) {
    ...
    switch (action) {
      case Action.create:
      case Action.update:
        (0, import_cash_dom.default)(`<div class=".message">
    ...
    const inputs = (0, import_cash_dom.default)('<div class=".inputs">').appendTo(contentEl);
    inputs.append((0, import_cash_dom.default)("<button>").text("Yes").on("click", () => {
      this.close();
      func();
    }));
    inputs.append((0, import_cash_dom.default)("<button>").text("No").on("click", () => this.close()));
    return this;
  }
...
var accountInfoHTML = `<div class="account-info">
...
var SettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Username").setDesc(`The username for creating Telegraph account`).addText((text) => text.setValue(this.plugin.settings.username).onChange((value) => __async(this, null, function* () {
      plugin.settings.username = value;
      yield plugin.saveSettings();
    })));
    new import_obsidian2.Setting(containerEl).setName("Access token").setDesc(`Telegraph access token. You can also leave it empty and click "Create new account"`).addText((text) => text.setValue(this.plugin.settings.accessToken).onChange((value) => __async(this, null, function* () {
    ...
    this.accountInfoEl = (0, import_cash_dom.default)(accountInfoHTML).appendTo(containerEl);
    this.errorEl = (0, import_cash_dom.default)(`<div class="error"></div>`).appendTo(containerEl);
    containerEl.createEl("h2", { text: "Misc" });
    new import_obsidian2.Setting(containerEl).setName("HTML Source").setDesc(`Choose how to get HTML for publishing.
				Preview: directly get HTML in preview mode;
				MarkdownRenderer: render HTML from markdown text,
				this option will disable the effects other plugins made to preview mode.`).addDropdown((dropdown) => dropdown.addOption(HTMLSource.Preview, HTMLSource.Preview).addOption(HTMLSource.MarkdownRenderer, HTMLSource.MarkdownRenderer).setValue(this.plugin.settings.htmlSource).onChange((value) => __async(this, null, function* () {
